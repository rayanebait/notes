...
\subsection{$B_{HT}$-admissibilité}
...
\begin{rem}
  ...
  D'où $t=2\pi i$ ici !
\end{rem}
\subsubsection{$B_{HT}$ est régulière}
...
$\C_K(\chi_K^i)^{G_K}=0$.
\subsubsection{$\Repp\to \textrm{Grad}_K$}
On a 
...
\subsubsection{Graduation et critère d'admissibilité}
...
\subsubsection{Poids de Hodge-Tate}
